...
{
    /// <summary>
    /// A String Tokenizer that accepts Strings as source and delimiter. 
    /// Only 1 delimiter is supported (either String or char[]).
    /// </summary>
    public class StringTokenizer
    {
        ...
        /// </summary>
        /// <param name="index">The position of the token</param>
        /// <returns></returns>
        public string TokenAt(int index)
        {
            if (CountTokens > index)
            {
