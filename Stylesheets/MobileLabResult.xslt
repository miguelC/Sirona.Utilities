...
<xsl:preserve-space elements="ObservationIdentifier"/>
          ...
          font-weight:bold;
			...
			<BODY  bgcolor="transparent" marginheight="0" marginwidth="0" rightmargin="0" leftmargin="0" topmargin="0" bottommargin="0" >
				<div align="left" style="padding-top:3px;padding-left:30px;">
					...
					<xsl:apply-templates mode="body" select="/labresult/patient/order" />
				<br/>
	...
	<xsl:template match="order" mode="header">	
				...
				<td valign='top'>
					<table border='0'>
						<tr>
							...
							<td  >
								<span  class='DataText' >
									<xsl:value-of select='./specimen/SpecimenSource/SpecimenSourceName/@Description'/>
								</span>
							</td>
						</tr>
						<tr>
						...
						<xsl:if test='./specimen/CollectionVolume/@Quantitiy != ""'>
							<tr>
								<td  >
									<span  class='Label' >Collection Volume: </span>
								</td>
								<td  >
									<span  class='DataText' >
										<xsl:value-of select='./specimen/CollectionVolume/@Quantitiy'/>
										<xsl:text> </xsl:text>
										<xsl:value-of select='./specimen/CollectionVolume/Units/@Description'/>
									</span>
								</td>			
							</tr>
						</xsl:if>
		...
		<span style="display:block; padding-Bottom:7px" align="left">
			<hr style="width:700px;"/>
			<table cellpadding='0' cellspacing='0' style='table-layout:fixed'>
				<colgroup>
					<col align='left' width='270px' />
				...
				<tbody>
					<tr>
						...
						<td class='captionFont'>Result</td>
						<td class='captionFont'>Flags</td>
						<td class='captionFont'>Reference Range</td>
						<td class='captionFont'>Lab</td>
					</tr>
				</tbody>
			</table>
			...
			<xsl:if test='count(/labresult/patient/notes) > 0'>
				<Table>
					<TR>
						<td valign='top'>
	...
	<xsl:template mode="body" match="order">
			...
			<xsl:choose>
				<xsl:when test='name() = "panel"'>
					...
					<xsl:if test='name(following-sibling::*[position()=1]) = "specimen"'>
						<br/>
						<xsl:apply-templates select="preceding-sibling::specimen[1]/notes"/>
						<br/><br/><br/>
					</xsl:if>
	...
	<xsl:template  match="notes">
		...
		<xsl:for-each select='./line' >
			<span class="NoteText" style="width:650px;margin-left:20px; word-wrap:break-word;">
