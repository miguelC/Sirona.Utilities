...
namespace Sirona.Utilities.Compression.Engine.Zip.Compression.Streams 
{
	...
	/// as the <see cref="Sirona.Utilities.Compression.GZip.GZipInputStream">GZipInputStream</see>.
	///
