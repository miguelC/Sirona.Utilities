...
using Sirona.Utilities.Compression.Checksums;
using Sirona.Utilities.Compression.Engine.Zip.Compression;
using Sirona.Utilities.Compression.Engine.Zip.Compression.Streams;

namespace Sirona.Utilities.Compression.Engine.Zip
{
	/// <summary>
	...
	/// using System.IO;
	/// 
	/// using Sirona.Utilities.Compression.Engine.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipInputStream : InflaterInputStream
	{
		...
		/// </exception>
		/// <exception name="Sirona.Utilities.Compression.Engine.ZipException">
